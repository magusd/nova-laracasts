    ...
    methods: {
        activateCache: function activateCache() {
            ...
            Nova.request().post('/nova-vendor/viewcache').then(function (data) {
                _this.$toasted.show('It worked!', { type: 'success' });
            });
        }
    }
});
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("View Cache")]),
      _vm._v(" "),
      _c(
        "card",
        {
        ...
        [
          ...
          _vm._v(" "),
          _c("h1", { staticClass: "text-4xl text-90 font-light mb-6" }, [
          ...
          _c(
            "button",
            {
              staticClass: "btn-default btn-primary",
